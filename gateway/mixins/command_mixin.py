...
class CommandMixin:
    """GatewayRunner mixin: command handlers."""
    ...
    async def _handle_model_command(self, event: MessageEvent) -> Optional[str]:
        ...
        """
        from gateway.run import _hermes_home, _load_gateway_config, _resolve_gateway_model, cfg_get
        import yaml
    ...
    async def _handle_personality_command(self, event: MessageEvent) -> str:
        ...
        from hermes_constants import display_hermes_home
        from gateway.run import _hermes_home, _load_gateway_config, cfg_get
    ...
    async def _handle_set_home_command(self, event: MessageEvent) -> str:
        ...
        from gateway._helpers import _home_target_env_var, _home_thread_env_var
    ...
    async def _handle_verbose_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _hermes_home, _load_gateway_config, _platform_config_key, cfg_get
    ...
    async def _handle_usage_command(self, event: MessageEvent) -> str:
        ...
        """
        from gateway.run import _AGENT_PENDING_SENTINEL
        from gateway.run import fetch_account_usage, render_account_usage_lines
        source = event.source
        session_key = self._session_key_for_source(source)
