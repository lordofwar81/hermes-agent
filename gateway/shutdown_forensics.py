...
def check_systemd_timing_alignment(
    ...
    # Dynamic: derived from the unit template (fork constraint: internal
    # budget 70s, TimeoutStopSec=90). A stale unit file with a shorter
    # TimeoutStopSec would cause SIGKILL mid-shutdown.
    expected = float(
