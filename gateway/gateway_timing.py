"""Time/duration helpers extracted from gateway/run.py during decomposition.

These are pure functions with no gateway state coupling; safe to import anywhere.
Names are kept identical to their originals in run.py so call sites are unchanged.
First extraction of the gateway decomposition refactor.
"""
